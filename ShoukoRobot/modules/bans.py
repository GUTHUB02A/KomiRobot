...
from ShoukoRobot.modules.helper_funcs.extraction import extract_user_and_text
from ShoukoRobot.modules.helper_funcs.string_handling import extract_time
from ShoukoRobot.modules.log_channel import gloggable, loggable
...
PUNCHME_HANDLER = DisableAbleCommandHandler(
    "punchme", punchme, filters=Filters.chat_type.groups)
