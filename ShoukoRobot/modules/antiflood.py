...
from ShoukoRobot import TIGERS, WOLVES, dispatcher
from ShoukoRobot.modules.helper_funcs.chat_status import (
    bot_admin, can_restrict, connection_status, is_user_admin, user_admin,
    user_admin_no_reply)
from ShoukoRobot.modules.log_channel import loggable
from ShoukoRobot.modules.sql import antiflood_sql as sql
...
from ShoukoRobot.modules.helper_funcs.chat_status import is_user_admin, user_admin, can_restrict
...
SET_FLOOD_MODE_HANDLER = CommandHandler(
    "setfloodmode", set_flood_mode, pass_args=True)  #, filters=Filters.chat_type.groups)
