...
from ShoukoRobot.modules.sql.users_sql import get_user_com_chats
import ShoukoRobot.modules.sql.global_bans_sql as sql
from ShoukoRobot import (DEV_USERS, EVENT_LOGS, OWNER_ID, STRICT_GBAN, DRAGONS,
                          SUPPORT_CHAT,  DEMONS, TIGERS,
                          WOLVES,dispatcher)
...
from ShoukoRobot.modules.helper_funcs.misc import send_to_list
from ShoukoRobot.modules.sql.users_sql import get_all_chats
