...
import ShoukoRobot.modules.sql.notes_sql as sql
from ShoukoRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from ShoukoRobot.__main__ import DATA_IMPORT
from ShoukoRobot.modules.helper_funcs.chat_status import user_admin
from ShoukoRobot.modules.helper_funcs.alternate import typing_action

# from ShoukoRobot.modules.rules import get_rules
import ShoukoRobot.modules.sql.rules_sql as rulessql

# from ShoukoRobot.modules.sql import warns_sql as warnssql
import ShoukoRobot.modules.sql.blacklist_sql as blacklistsql
from ShoukoRobot.modules.sql import disable_sql as disabledsql

# from ShoukoRobot.modules.sql import cust_filters_sql as filtersql
# import ShoukoRobot.modules.sql.welcome_sql as welcsql
import ShoukoRobot.modules.sql.locks_sql as locksql
from ShoukoRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("ShoukoRobot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ShoukoRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ShoukoRobot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("ShoukoRobot{}.backup".format(chat_id))  # Cleaning file
