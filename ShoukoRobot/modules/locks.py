...
import ShoukoRobot.modules.sql.locks_sql as sql
from ShoukoRobot import dispatcher, DRAGONS, LOGGER
...
LOCK_HANDLER = CommandHandler(
    "lock", lock, pass_args=True)  # , filters=Filters.chat_type.groups)
