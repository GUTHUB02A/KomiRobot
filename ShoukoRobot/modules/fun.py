...
import ShoukoRobot.modules.fun_strings as fun_strings
...
__command_list__ = [
    ...
    "table", "pat", "sanitize","shout", "truth" , "sigma", "dare"
]
__handlers__ = [
    ...
    SANITIZE_HANDLER , SHOUT_HANDLER ,SIGMA_HANDLER , TRUTH_HANDLER
]
